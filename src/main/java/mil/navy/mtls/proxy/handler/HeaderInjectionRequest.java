 ...
 * @author tmoreno
 */
public class HeaderInjectionRequest implements ServiceHandler {
    ...
    public void process(String forwardUrl, HttpServletRequest requestServlet, HttpServletResponse responseServlet, SSLProperties sslProperties) throws Exception {
        ...
        while (headerNames.hasMoreElements()) {
            ...
            Logger.getLogger(HeaderInjectionRequest.class.getName()).log(Level.INFO, "{0}:{1}", new String[] { headerName, headerValue });
